...
public class Connection {
	...
	// Declaring  globals	
		...
		try {
			...
			con = (HttpURLConnection) obj.openConnection();		//	establishing connection 
			// Creating SOAPAction POST request
			...
			if (responseCode == HttpURLConnection.HTTP_OK) { // in case of success, writing xml response to NewFile.xml
				...
				// making xml file readable be string manipulation.
